...
<html lang="en">
  <head>
    <title>GoCheeta - Cab Service System</title>
    <meta charset="utf-8">
  ...
  <body>
	  ...
	  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container">
	      <a class="navbar-brand" href="index.jsp">Go<span>Cheeta</span></a>
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          ...
	          <li class="nav-item active"><a href="car.jsp" class="nav-link">Cars</a></li>
	          <li class="nav-item"><a href="blog.jsp" class="nav-link">Blog</a></li>
	          <li class="nav-item"><a href="contact.jsp" class="nav-link">Contact</a></li>
	          <li class="nav-item"><a href="logout" class="nav-link">Logout <%=session.getAttribute("name")%></a></li>
	        </ul>
	      </div>
	    </div>
	  </nav>
    			...
    			<div class="col-md-4">
    				<div class="car-wrap rounded ftco-animate">
    					...
    					<div class="text">
    						...
    						<p class="d-flex mb-0 d-block"><a href="https://form.jotform.com/222614374312448" class="btn btn-primary py-2 mr-1">Book now</a> <a href="car-single.jsp" class="btn btn-secondary py-2 ml-1">Details</a></p>
    					</div>
    				</div>
    			</div>
    			<div class="col-md-4">
    			...
    			<div class="col-md-4">
    				<div class="car-wrap rounded ftco-animate">
    					...
    					<div class="text">
    						...
    						<p class="d-flex mb-0 d-block"><a href="https://form.jotform.com/222614374312448" class="btn btn-primary py-2 mr-1">Book now</a> <a href="car-single." class="btn btn-secondary py-2 ml-1">Details</a></p>
    					</div>
    				</div>
    			</div>
